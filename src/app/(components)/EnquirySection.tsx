    ...
    <section className="xl:max-w-7xl max-w-[90%] my-16 mx-auto">
      <div className="flex md:flex-row flex-col gap-0 h-full">
        <div className="md:w-1/2 w-full">
          <button className="w-full lg:min-h-[25em] md:min-h-[15rem] bg-[#FFE1DE] hover:bg-[#ffcec9] duration-300 transition-colors px-8 py-4 flex flex-col items-center justify-center gap-5">
